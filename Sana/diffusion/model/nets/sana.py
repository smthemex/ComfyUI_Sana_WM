...
from ..nets.basic_modules import DWMlp, GLUMBConv, MBConvPreGLU, Mlp
...
if is_triton_module_available():
    from ..nets.fastlinear.modules import TritonLiteMLA, TritonMBConvPreGLU
...
class Sana(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        drop_path = [drop_path * i / (depth - 1) if depth > 1 else 0.0 for i in range(depth)] # 改成纯python的等差数列计算以契合meta加载
        if attn_type == "flash":
