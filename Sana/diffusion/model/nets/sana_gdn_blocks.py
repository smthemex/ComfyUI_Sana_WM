...
from ...distributed.context_parallel.config import cp_enabled, get_cp_group
    ...
    def __init__(
        ...
        **kwargs: object,
        ...
        if update_rule_func == "torch_recurrent_sana_gdn":
            ...
            from ..ops.frame_gdn import triton_chunk_sana_gdn
            ...
            from ..ops.frame_gdn import triton_recurrent_sana_gdn
