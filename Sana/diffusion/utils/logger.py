...
def get_logger(name="SanaWM", log_file=None, log_level=logging.INFO):
    """Simplified logger without distributed and timezone logic."""
...
def get_logger_(name, log_file=None, log_level=logging.INFO, timezone="UTC"):
